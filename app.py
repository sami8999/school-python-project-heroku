        ...
        return html.Div([
            html.Div([
                ...
                html.Img(
                    ...
                    # html.Img(src= app.get_asset_url('stock-icon.png'))
                    n_clicks=0,
                    className='info-icon',
                ),
...
@app.callback(Output('modal2', 'style'),
...
@app.callback(Output('instructions-button2', 'n_clicks'),
...
@app.callback(Output('modal3', 'style'),
...
@app.callback(Output('instructions-button3', 'n_clicks'),
...
@app.callback(Output('modal4', 'style'),
...
@app.callback(Output('instructions-button4', 'n_clicks'),
